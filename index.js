...
// When a function does not contain the information asked for, it will look to the next available scope, in this case myFunction().  The internal variable was declared in myFunction, so when nestedFunction was asked to console.log the internal variable, it reached into the myFunction and found the requested variable.  This allowed nestedFunction to console.log the internal variable, and this action also created a closure.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(data, animal_name, scientific_name){ 
    const displayNames = [];
...
console.log(animalNames(zooAnimals, 'Jackal, asiatic', 'Canis aureus'));
  ...
  */
  ...
  function USApop(data){
    const usPop = data.reduce(function(acc, item){
